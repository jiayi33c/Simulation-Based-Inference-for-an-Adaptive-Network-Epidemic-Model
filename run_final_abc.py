...
def run_batch(batch_idx, batch_size, observed_summary, summary_scale, selected_columns):
    ...
    batch_path = BATCH_DIR / f"batch_{batch_idx:04d}.csv"
...
if __name__ == "__main__":
    ...
    all_results.to_csv(RESULTS_DIR / "final_results_infected_plus_rewiring.csv", index=False)
    accepted.to_csv(RESULTS_DIR / "final_accepted_infected_plus_rewiring.csv", index=False)
